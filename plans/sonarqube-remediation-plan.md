...
Дата анализа SonarQube: 2026-07-06 16:13:41 UTC
...
- Security Hotspots: 15 всего, 1 имеет статус `TO_REVIEW`.
- Общая coverage: 52.7%.
- Условия, из-за которых Quality Gate красный:
  - coverage нового кода: 61.3% при пороге 80%;
  - reviewed security hotspots нового кода: 75% при требовании 100%;
  - new violations: 4.
- Дублирование нового кода проходит gate: 0.0% при пороге 3%.
...
Свежий анализ снят после коммита
`a5c5bf38d23c78cf824bb6c186f8a6bda586f1f4`, который существенно изменил
`app/cli.py`. Поэтому восемь CLI-issues из исходного снимка были повторно
сверены на актуальном `main`.
...
#### Статус этапа 0 на 2026-07-06

- Jenkins build `#64` для актуального `main` завершился успешно и загрузил новый
  анализ SonarQube от `2026-07-06 16:13:41 UTC`.
- По восьми историческим ключам `app/cli.py` подтверждено:
  `b591dc12-db21-4875-a636-6e3903666d6e` уже закрыт, а
  `eb4a59d1-fc34-40ad-8bc3-058af659b9d6`,
  `06b7e4f3-5096-441c-b016-8bb1266985fd`,
  `31c4d747-8225-464b-8927-0a6f41b21d64`,
  `280c2471-d337-41ae-8a7f-5daa8e808703`,
  ...
  `17b88ed0-51a2-4812-b1dd-58cccab0fdc9`
  остаются открытыми.
- Дополнительно в актуальном `app/cli.py` появились новые issues после
  рефакторинга `WorkerRuntime`:
  `1cb01e7e-61ce-4491-8486-74e355fe9836`,
  `85b99a63-9921-4c18-b5b8-3765662c6641`,
  `979cb583-cbd7-4e53-920a-f74e502b06c8`,
  `20882550-91e8-4807-8d04-23832cafffab`.
- Решение по старой админке подтверждено: 56 issues `app/ui.html` остаются
  видимыми в SonarQube как осознанный долг и в первую волну не входят.
- Три hotspot из исходных `TO_REVIEW` уже переведены в согласованные состояния;
  единственный оставшийся `TO_REVIEW` — `6550f731-6547-454d-8810-5073f0460bd3`
  в `deploy/ci/Dockerfile.ui-test`.
- `New Code Period` сознательно не зафиксирован на этом шаге. Попытка выставить
