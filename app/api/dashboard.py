...
def api_v1_dashboard(
    ...
    shelf_keys = ["mixes_for_you", "albums_for_you", "new_releases", "liked_artists", "discover_random", "listen_again", "long_time_no_listen", "recently_added", "history", "liked_releases"]
    shelves = [
        shelf
