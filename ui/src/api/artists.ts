...
import type { ArtistDiscographyResponse, ArtistAvailabilityStub, ArtistResponse } from "./types"
...
export function fetchArtistTopTracks(id: number): Promise<ArtistAvailabilityStub> {
